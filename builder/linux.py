...
class LinuxBuilder(Builder):
	...
	def package(self):
		...
		archive_name = "%s-%s-%s-%s-%s-%s-%s.tar.bz2" % (self.project, self.version, self.commits, self.revision, self.host_linux['short_name'], self.host_linux['version'], self.build_arch)
