...
!insertmacro MUI_PAGE_LICENSE "RELDIR\copyright.txt"
...
Caption "V-Ray/Blender VERSION Installer"
OutFile "[INSTALLER_DIR]\\[INSTALLER_NAME]"
InstallDir "$PROGRAMFILES\V-RayBlender-VERSION"

BrandingText "http://vray.cgdo.ru"
ComponentText "This will install V-Ray/Blender VERSION on your computer."
...
Section "Add Start Menu shortcuts" Section2
  ...
  CreateShortCut "$SMPROGRAMS\V-RayBlender\V-RayBlender-VERSION.lnk" "$INSTDIR\Blender.exe" "" "$INSTDIR\blender.exe" 0
...
Section "Add Desktop V-Ray/Blender-VERSION shortcut" Section3
  SetOutPath $INSTDIR
  CreateShortCut "$DESKTOP\V-RayBlender-VERSION.lnk" "$INSTDIR\blender.exe" "" "$INSTDIR\blender.exe" 0
SectionEnd


Section "Open .blend files with V-Ray/Blender-VERSION" Section4
  SetOutPath $INSTDIR
