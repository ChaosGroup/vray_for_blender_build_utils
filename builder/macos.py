...
class MacBuilder(Builder):
	...
	def compile(self):
		...
		cmake.append("-DWITH_GAMEENGINE=OFF")# % utils.GetCmakeOnOff(self.with_ge))
		cmake.append("-DWITH_PLAYER=OFF")# % utils.GetCmakeOnOff(self.with_player))
		cmake.append("-DWITH_LIBMV=OFF")# % utils.GetCmakeOnOff(self.with_tracker))
		cmake.append("-DWITH_OPENCOLLADA=OFF")# % utils.GetCmakeOnOff(self.with_collada))
		cmake.append("-DWITH_CYCLES=OFF")# % utils.GetCmakeOnOff(self.with_cycles))
